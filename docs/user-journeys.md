...
1. Add a file whose columns are awkward — repeated names, unnamed analog inputs, sensors that
   never move — and choose **Show Import Report…** in its inspector or the Project menu, or ⌘2
...
`testCommandDigitsSwitchTheWindowsView`, `testShowImportReportOpensOnTheReport`. Model:

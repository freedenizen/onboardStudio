...
DOWNLOAD_PREFIX="${DOWNLOAD_PREFIX:-https://github.com/freedenizen/onboardStudio/releases/download/v$(/usr/libexec/PlistBuddy -c 'Print CFBundleShortVersionString' dist/OnboardStudio.app/Contents/Info.plist)/}"
